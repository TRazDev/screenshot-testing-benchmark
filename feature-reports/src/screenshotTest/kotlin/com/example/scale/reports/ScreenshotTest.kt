...
@ScreenshotMatrix
@Composable
fun ReportsReport0ScreenPreviewScreenshot() {
    ReportsReport0ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun ReportsReport1ScreenPreviewScreenshot() {
    ReportsReport1ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun ReportsAlbum2ScreenPreviewScreenshot() {
    ReportsAlbum2ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun ReportsPayment3ScreenPreviewScreenshot() {
    ReportsPayment3ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun ReportsAlbum4ScreenPreviewScreenshot() {
    ReportsAlbum4ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun ReportsExpense5ScreenPreviewScreenshot() {
    ReportsExpense5ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun ReportsReport6ScreenPreviewScreenshot() {
    ReportsReport6ScreenPreview()
}
