...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        ReportsReport0Screen({ ReportsReport0ScreenPreview() }),
        ReportsReport1Screen({ ReportsReport1ScreenPreview() }),
        ReportsAlbum2Screen({ ReportsAlbum2ScreenPreview() }),
        ReportsPayment3Screen({ ReportsPayment3ScreenPreview() }),
        ReportsAlbum4Screen({ ReportsAlbum4ScreenPreview() }),
        ReportsExpense5Screen({ ReportsExpense5ScreenPreview() }),
        ReportsReport6Screen({ ReportsReport6ScreenPreview() })
    }
