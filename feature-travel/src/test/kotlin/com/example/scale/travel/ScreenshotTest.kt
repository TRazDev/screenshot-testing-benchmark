...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        TravelRoute0Screen({ TravelRoute0ScreenPreview() }),
        TravelPayment1Screen({ TravelPayment1ScreenPreview() }),
        TravelInvoice2Screen({ TravelInvoice2ScreenPreview() }),
        TravelHabit3Screen({ TravelHabit3ScreenPreview() }),
        TravelShipment4Screen({ TravelShipment4ScreenPreview() }),
        TravelBooking5Screen({ TravelBooking5ScreenPreview() }),
        TravelDevice6Screen({ TravelDevice6ScreenPreview() }),
        TravelPayment7Screen({ TravelPayment7ScreenPreview() }),
        TravelReport8Screen({ TravelReport8ScreenPreview() }),
        TravelAlbum9Screen({ TravelAlbum9ScreenPreview() }),
        TravelPortfolio10Screen({ TravelPortfolio10ScreenPreview() }),
        TravelAlbum11Screen({ TravelAlbum11ScreenPreview() }),
        TravelLesson12Screen({ TravelLesson12ScreenPreview() }),
        TravelRoute13Screen({ TravelRoute13ScreenPreview() })
    }
