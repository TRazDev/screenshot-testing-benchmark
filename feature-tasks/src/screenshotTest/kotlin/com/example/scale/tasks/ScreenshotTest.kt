...
@ScreenshotMatrix
@Composable
fun TasksInvoice0ScreenPreviewScreenshot() {
    TasksInvoice0ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun TasksSubscription1ScreenPreviewScreenshot() {
    TasksSubscription1ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun TasksPayment2ScreenPreviewScreenshot() {
    TasksPayment2ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun TasksRoute3ScreenPreviewScreenshot() {
    TasksRoute3ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun TasksReservation4ScreenPreviewScreenshot() {
    TasksReservation4ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun TasksExpense5ScreenPreviewScreenshot() {
    TasksExpense5ScreenPreview()
}
