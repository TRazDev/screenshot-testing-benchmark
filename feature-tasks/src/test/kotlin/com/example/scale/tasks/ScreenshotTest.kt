...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        TasksInvoice0Screen({ TasksInvoice0ScreenPreview() }),
        TasksSubscription1Screen({ TasksSubscription1ScreenPreview() }),
        TasksPayment2Screen({ TasksPayment2ScreenPreview() }),
        TasksRoute3Screen({ TasksRoute3ScreenPreview() }),
        TasksReservation4Screen({ TasksReservation4ScreenPreview() }),
        TasksExpense5Screen({ TasksExpense5ScreenPreview() })
    }
