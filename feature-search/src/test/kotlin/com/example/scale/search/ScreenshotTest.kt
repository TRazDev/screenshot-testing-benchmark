...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        SearchReservation0Screen({ SearchReservation0ScreenPreview() }),
        SearchLesson1Screen({ SearchLesson1ScreenPreview() }),
        SearchTicket2Screen({ SearchTicket2ScreenPreview() }),
        SearchTicket3Screen({ SearchTicket3ScreenPreview() }),
        SearchLesson4Screen({ SearchLesson4ScreenPreview() }),
        SearchInvoice5Screen({ SearchInvoice5ScreenPreview() }),
        SearchInvoice6Screen({ SearchInvoice6ScreenPreview() }),
        SearchDevice7Screen({ SearchDevice7ScreenPreview() }),
        SearchBudget8Screen({ SearchBudget8ScreenPreview() }),
        SearchWorkout9Screen({ SearchWorkout9ScreenPreview() }),
        SearchAlbum10Screen({ SearchAlbum10ScreenPreview() }),
        SearchAlbum11Screen({ SearchAlbum11ScreenPreview() }),
        SearchBudget12Screen({ SearchBudget12ScreenPreview() })
    }
