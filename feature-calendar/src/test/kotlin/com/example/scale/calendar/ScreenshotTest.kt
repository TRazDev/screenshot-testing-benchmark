...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        CalendarReport0Screen({ CalendarReport0ScreenPreview() }),
        CalendarBudget1Screen({ CalendarBudget1ScreenPreview() }),
        CalendarArticle2Screen({ CalendarArticle2ScreenPreview() }),
        CalendarReport3Screen({ CalendarReport3ScreenPreview() }),
        CalendarInvoice4Screen({ CalendarInvoice4ScreenPreview() }),
        CalendarContact5Screen({ CalendarContact5ScreenPreview() }),
        CalendarWorkout6Screen({ CalendarWorkout6ScreenPreview() }),
        CalendarAlbum7Screen({ CalendarAlbum7ScreenPreview() }),
        CalendarBudget8Screen({ CalendarBudget8ScreenPreview() })
    }
