...
@ScreenshotMatrix
@Composable
fun CalendarReport0ScreenPreviewScreenshot() {
    CalendarReport0ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CalendarBudget1ScreenPreviewScreenshot() {
    CalendarBudget1ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CalendarArticle2ScreenPreviewScreenshot() {
    CalendarArticle2ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CalendarReport3ScreenPreviewScreenshot() {
    CalendarReport3ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CalendarInvoice4ScreenPreviewScreenshot() {
    CalendarInvoice4ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CalendarContact5ScreenPreviewScreenshot() {
    CalendarContact5ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CalendarWorkout6ScreenPreviewScreenshot() {
    CalendarWorkout6ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CalendarAlbum7ScreenPreviewScreenshot() {
    CalendarAlbum7ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CalendarBudget8ScreenPreviewScreenshot() {
    CalendarBudget8ScreenPreview()
}
