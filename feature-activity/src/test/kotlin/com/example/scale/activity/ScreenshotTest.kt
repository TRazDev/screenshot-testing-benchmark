...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        ActivityRecipe0Screen({ ActivityRecipe0ScreenPreview() }),
        ActivityTask1Screen({ ActivityTask1ScreenPreview() }),
        ActivityContact2Screen({ ActivityContact2ScreenPreview() }),
        ActivityRecipe3Screen({ ActivityRecipe3ScreenPreview() }),
        ActivityInvoice4Screen({ ActivityInvoice4ScreenPreview() }),
        ActivityShipment5Screen({ ActivityShipment5ScreenPreview() }),
        ActivityProject6Screen({ ActivityProject6ScreenPreview() }),
        ActivityDevice7Screen({ ActivityDevice7ScreenPreview() }),
        ActivityBooking8Screen({ ActivityBooking8ScreenPreview() }),
        ActivityRecipe9Screen({ ActivityRecipe9ScreenPreview() }),
        ActivityShipment10Screen({ ActivityShipment10ScreenPreview() }),
        ActivityRecipe11Screen({ ActivityRecipe11ScreenPreview() }),
        ActivitySubscription12Screen({ ActivitySubscription12ScreenPreview() }),
        ActivityContact13Screen({ ActivityContact13ScreenPreview() })
    }
