...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        TeamsReservation0Screen({ TeamsReservation0ScreenPreview() }),
        TeamsTicket1Screen({ TeamsTicket1ScreenPreview() }),
        TeamsInvoice2Screen({ TeamsInvoice2ScreenPreview() }),
        TeamsShipment3Screen({ TeamsShipment3ScreenPreview() }),
        TeamsOrder4Screen({ TeamsOrder4ScreenPreview() }),
        TeamsProject5Screen({ TeamsProject5ScreenPreview() }),
        TeamsPortfolio6Screen({ TeamsPortfolio6ScreenPreview() }),
        TeamsTask7Screen({ TeamsTask7ScreenPreview() }),
        TeamsRecipe8Screen({ TeamsRecipe8ScreenPreview() }),
        TeamsHabit9Screen({ TeamsHabit9ScreenPreview() }),
        TeamsOrder10Screen({ TeamsOrder10ScreenPreview() }),
        TeamsArticle11Screen({ TeamsArticle11ScreenPreview() }),
        TeamsTicket12Screen({ TeamsTicket12ScreenPreview() })
    }
