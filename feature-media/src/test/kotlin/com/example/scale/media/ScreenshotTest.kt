...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        MediaBudget0Screen({ MediaBudget0ScreenPreview() }),
        MediaPayment1Screen({ MediaPayment1ScreenPreview() }),
        MediaOrder2Screen({ MediaOrder2ScreenPreview() }),
        MediaShipment3Screen({ MediaShipment3ScreenPreview() }),
        MediaArticle4Screen({ MediaArticle4ScreenPreview() }),
        MediaProject5Screen({ MediaProject5ScreenPreview() })
    }
