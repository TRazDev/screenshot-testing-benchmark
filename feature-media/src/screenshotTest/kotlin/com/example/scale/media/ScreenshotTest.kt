...
@ScreenshotMatrix
@Composable
fun MediaBudget0ScreenPreviewScreenshot() {
    MediaBudget0ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun MediaPayment1ScreenPreviewScreenshot() {
    MediaPayment1ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun MediaOrder2ScreenPreviewScreenshot() {
    MediaOrder2ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun MediaShipment3ScreenPreviewScreenshot() {
    MediaShipment3ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun MediaArticle4ScreenPreviewScreenshot() {
    MediaArticle4ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun MediaProject5ScreenPreviewScreenshot() {
    MediaProject5ScreenPreview()
}
