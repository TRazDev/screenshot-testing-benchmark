...
@ScreenshotMatrix
@Composable
fun FinanceDevice0ScreenPreviewScreenshot() {
    FinanceDevice0ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinanceInvoice1ScreenPreviewScreenshot() {
    FinanceInvoice1ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinanceWorkout2ScreenPreviewScreenshot() {
    FinanceWorkout2ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinancePayment3ScreenPreviewScreenshot() {
    FinancePayment3ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinanceReservation4ScreenPreviewScreenshot() {
    FinanceReservation4ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinanceBudget5ScreenPreviewScreenshot() {
    FinanceBudget5ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinanceOrder6ScreenPreviewScreenshot() {
    FinanceOrder6ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinanceRoute7ScreenPreviewScreenshot() {
    FinanceRoute7ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinanceReservation8ScreenPreviewScreenshot() {
    FinanceReservation8ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinanceContact9ScreenPreviewScreenshot() {
    FinanceContact9ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinanceOrder10ScreenPreviewScreenshot() {
    FinanceOrder10ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinanceInvoice11ScreenPreviewScreenshot() {
    FinanceInvoice11ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinanceReservation12ScreenPreviewScreenshot() {
    FinanceReservation12ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun FinanceTask13ScreenPreviewScreenshot() {
    FinanceTask13ScreenPreview()
}
