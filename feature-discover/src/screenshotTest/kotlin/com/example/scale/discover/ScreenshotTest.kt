...
@ScreenshotMatrix
@Composable
fun DiscoverHabit0ScreenPreviewScreenshot() {
    DiscoverHabit0ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DiscoverPlaylist1ScreenPreviewScreenshot() {
    DiscoverPlaylist1ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DiscoverReport2ScreenPreviewScreenshot() {
    DiscoverReport2ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DiscoverWorkout3ScreenPreviewScreenshot() {
    DiscoverWorkout3ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DiscoverRoute4ScreenPreviewScreenshot() {
    DiscoverRoute4ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DiscoverReservation5ScreenPreviewScreenshot() {
    DiscoverReservation5ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DiscoverRecipe6ScreenPreviewScreenshot() {
    DiscoverRecipe6ScreenPreview()
}
