...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        DiscoverHabit0Screen({ DiscoverHabit0ScreenPreview() }),
        DiscoverPlaylist1Screen({ DiscoverPlaylist1ScreenPreview() }),
        DiscoverReport2Screen({ DiscoverReport2ScreenPreview() }),
        DiscoverWorkout3Screen({ DiscoverWorkout3ScreenPreview() }),
        DiscoverRoute4Screen({ DiscoverRoute4ScreenPreview() }),
        DiscoverReservation5Screen({ DiscoverReservation5ScreenPreview() }),
        DiscoverRecipe6Screen({ DiscoverRecipe6ScreenPreview() })
    }
