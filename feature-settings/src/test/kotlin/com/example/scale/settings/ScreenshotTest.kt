...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        SettingsAlbum0Screen({ SettingsAlbum0ScreenPreview() }),
        SettingsRecipe1Screen({ SettingsRecipe1ScreenPreview() }),
        SettingsBudget2Screen({ SettingsBudget2ScreenPreview() }),
        SettingsReport3Screen({ SettingsReport3ScreenPreview() }),
        SettingsRoute4Screen({ SettingsRoute4ScreenPreview() }),
        SettingsBooking5Screen({ SettingsBooking5ScreenPreview() }),
        SettingsAlbum6Screen({ SettingsAlbum6ScreenPreview() }),
        SettingsShipment7Screen({ SettingsShipment7ScreenPreview() }),
        SettingsExpense8Screen({ SettingsExpense8ScreenPreview() }),
        SettingsContact9Screen({ SettingsContact9ScreenPreview() })
    }
