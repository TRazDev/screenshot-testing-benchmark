...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        SupportBudget0Screen({ SupportBudget0ScreenPreview() }),
        SupportBudget1Screen({ SupportBudget1ScreenPreview() }),
        SupportHabit2Screen({ SupportHabit2ScreenPreview() }),
        SupportTicket3Screen({ SupportTicket3ScreenPreview() }),
        SupportProject4Screen({ SupportProject4ScreenPreview() }),
        SupportWorkout5Screen({ SupportWorkout5ScreenPreview() }),
        SupportSubscription6Screen({ SupportSubscription6ScreenPreview() }),
        SupportTask7Screen({ SupportTask7ScreenPreview() }),
        SupportLesson8Screen({ SupportLesson8ScreenPreview() })
    }
