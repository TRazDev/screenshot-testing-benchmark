...
@ScreenshotMatrix
@Composable
fun SupportBudget0ScreenPreviewScreenshot() {
    SupportBudget0ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun SupportBudget1ScreenPreviewScreenshot() {
    SupportBudget1ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun SupportHabit2ScreenPreviewScreenshot() {
    SupportHabit2ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun SupportTicket3ScreenPreviewScreenshot() {
    SupportTicket3ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun SupportProject4ScreenPreviewScreenshot() {
    SupportProject4ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun SupportWorkout5ScreenPreviewScreenshot() {
    SupportWorkout5ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun SupportSubscription6ScreenPreviewScreenshot() {
    SupportSubscription6ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun SupportTask7ScreenPreviewScreenshot() {
    SupportTask7ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun SupportLesson8ScreenPreviewScreenshot() {
    SupportLesson8ScreenPreview()
}
