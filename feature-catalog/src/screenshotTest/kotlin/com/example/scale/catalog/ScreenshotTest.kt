...
@ScreenshotMatrix
@Composable
fun CatalogBooking0ScreenPreviewScreenshot() {
    CatalogBooking0ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CatalogPayment1ScreenPreviewScreenshot() {
    CatalogPayment1ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CatalogTask2ScreenPreviewScreenshot() {
    CatalogTask2ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CatalogPlaylist3ScreenPreviewScreenshot() {
    CatalogPlaylist3ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CatalogPortfolio4ScreenPreviewScreenshot() {
    CatalogPortfolio4ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CatalogWorkout5ScreenPreviewScreenshot() {
    CatalogWorkout5ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CatalogContact6ScreenPreviewScreenshot() {
    CatalogContact6ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun CatalogRoute7ScreenPreviewScreenshot() {
    CatalogRoute7ScreenPreview()
}
