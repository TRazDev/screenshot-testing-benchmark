...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        CatalogBooking0Screen({ CatalogBooking0ScreenPreview() }),
        CatalogPayment1Screen({ CatalogPayment1ScreenPreview() }),
        CatalogTask2Screen({ CatalogTask2ScreenPreview() }),
        CatalogPlaylist3Screen({ CatalogPlaylist3ScreenPreview() }),
        CatalogPortfolio4Screen({ CatalogPortfolio4ScreenPreview() }),
        CatalogWorkout5Screen({ CatalogWorkout5ScreenPreview() }),
        CatalogContact6Screen({ CatalogContact6ScreenPreview() }),
        CatalogRoute7Screen({ CatalogRoute7ScreenPreview() })
    }
