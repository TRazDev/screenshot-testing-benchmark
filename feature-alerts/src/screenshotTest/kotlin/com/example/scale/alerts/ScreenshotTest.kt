...
@ScreenshotMatrix
@Composable
fun AlertsInvoice0ScreenPreviewScreenshot() {
    AlertsInvoice0ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun AlertsRecipe1ScreenPreviewScreenshot() {
    AlertsRecipe1ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun AlertsProject2ScreenPreviewScreenshot() {
    AlertsProject2ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun AlertsBudget3ScreenPreviewScreenshot() {
    AlertsBudget3ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun AlertsWorkout4ScreenPreviewScreenshot() {
    AlertsWorkout4ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun AlertsShipment5ScreenPreviewScreenshot() {
    AlertsShipment5ScreenPreview()
}
