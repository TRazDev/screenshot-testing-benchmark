...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        AlertsInvoice0Screen({ AlertsInvoice0ScreenPreview() }),
        AlertsRecipe1Screen({ AlertsRecipe1ScreenPreview() }),
        AlertsProject2Screen({ AlertsProject2ScreenPreview() }),
        AlertsBudget3Screen({ AlertsBudget3ScreenPreview() }),
        AlertsWorkout4Screen({ AlertsWorkout4ScreenPreview() }),
        AlertsShipment5Screen({ AlertsShipment5ScreenPreview() })
    }
