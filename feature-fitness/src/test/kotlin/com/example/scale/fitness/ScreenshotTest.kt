...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        FitnessInvoice0Screen({ FitnessInvoice0ScreenPreview() }),
        FitnessDevice1Screen({ FitnessDevice1ScreenPreview() }),
        FitnessContact2Screen({ FitnessContact2ScreenPreview() }),
        FitnessReport3Screen({ FitnessReport3ScreenPreview() }),
        FitnessExpense4Screen({ FitnessExpense4ScreenPreview() }),
        FitnessHabit5Screen({ FitnessHabit5ScreenPreview() }),
        FitnessHabit6Screen({ FitnessHabit6ScreenPreview() }),
        FitnessWorkout7Screen({ FitnessWorkout7ScreenPreview() }),
        FitnessLesson8Screen({ FitnessLesson8ScreenPreview() })
    }
