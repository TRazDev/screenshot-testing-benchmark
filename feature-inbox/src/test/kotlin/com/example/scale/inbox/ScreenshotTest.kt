...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        InboxAlbum0Screen({ InboxAlbum0ScreenPreview() }),
        InboxContact1Screen({ InboxContact1ScreenPreview() }),
        InboxProject2Screen({ InboxProject2ScreenPreview() }),
        InboxArticle3Screen({ InboxArticle3ScreenPreview() }),
        InboxPlaylist4Screen({ InboxPlaylist4ScreenPreview() }),
        InboxTicket5Screen({ InboxTicket5ScreenPreview() }),
        InboxShipment6Screen({ InboxShipment6ScreenPreview() }),
        InboxInvoice7Screen({ InboxInvoice7ScreenPreview() }),
        InboxExpense8Screen({ InboxExpense8ScreenPreview() }),
        InboxArticle9Screen({ InboxArticle9ScreenPreview() }),
        InboxArticle10Screen({ InboxArticle10ScreenPreview() }),
        InboxSubscription11Screen({ InboxSubscription11ScreenPreview() }),
        InboxSubscription12Screen({ InboxSubscription12ScreenPreview() })
    }
