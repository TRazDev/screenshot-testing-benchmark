...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        NotesSubscription0Screen({ NotesSubscription0ScreenPreview() }),
        NotesReservation1Screen({ NotesReservation1ScreenPreview() }),
        NotesReservation2Screen({ NotesReservation2ScreenPreview() }),
        NotesTicket3Screen({ NotesTicket3ScreenPreview() }),
        NotesAlbum4Screen({ NotesAlbum4ScreenPreview() }),
        NotesReservation5Screen({ NotesReservation5ScreenPreview() }),
        NotesTicket6Screen({ NotesTicket6ScreenPreview() }),
        NotesPortfolio7Screen({ NotesPortfolio7ScreenPreview() }),
        NotesDevice8Screen({ NotesDevice8ScreenPreview() }),
        NotesPortfolio9Screen({ NotesPortfolio9ScreenPreview() }),
        NotesRoute10Screen({ NotesRoute10ScreenPreview() })
    }
