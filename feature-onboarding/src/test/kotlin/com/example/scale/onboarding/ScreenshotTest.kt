...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        OnboardingPayment0Screen({ OnboardingPayment0ScreenPreview() }),
        OnboardingRoute1Screen({ OnboardingRoute1ScreenPreview() }),
        OnboardingTask2Screen({ OnboardingTask2ScreenPreview() }),
        OnboardingSubscription3Screen({ OnboardingSubscription3ScreenPreview() }),
        OnboardingRoute4Screen({ OnboardingRoute4ScreenPreview() }),
        OnboardingExpense5Screen({ OnboardingExpense5ScreenPreview() })
    }
