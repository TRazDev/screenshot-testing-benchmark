...
@ScreenshotMatrix
@Composable
fun OnboardingPayment0ScreenPreviewScreenshot() {
    OnboardingPayment0ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun OnboardingRoute1ScreenPreviewScreenshot() {
    OnboardingRoute1ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun OnboardingTask2ScreenPreviewScreenshot() {
    OnboardingTask2ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun OnboardingSubscription3ScreenPreviewScreenshot() {
    OnboardingSubscription3ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun OnboardingRoute4ScreenPreviewScreenshot() {
    OnboardingRoute4ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun OnboardingExpense5ScreenPreviewScreenshot() {
    OnboardingExpense5ScreenPreview()
}
