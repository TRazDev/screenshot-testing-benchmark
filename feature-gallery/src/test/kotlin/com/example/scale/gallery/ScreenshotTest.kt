...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        GallerySubscription0Screen({ GallerySubscription0ScreenPreview() }),
        GalleryReservation1Screen({ GalleryReservation1ScreenPreview() }),
        GalleryTask2Screen({ GalleryTask2ScreenPreview() }),
        GalleryArticle3Screen({ GalleryArticle3ScreenPreview() }),
        GalleryTicket4Screen({ GalleryTicket4ScreenPreview() }),
        GalleryRecipe5Screen({ GalleryRecipe5ScreenPreview() }),
        GalleryWorkout6Screen({ GalleryWorkout6ScreenPreview() }),
        GalleryPayment7Screen({ GalleryPayment7ScreenPreview() }),
        GalleryBooking8Screen({ GalleryBooking8ScreenPreview() })
    }
