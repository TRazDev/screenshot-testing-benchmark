...
@Composable
public fun BillingInvoice0Screen() {
    AppScreen(
        title = "Invoice details",
        tabs = listOf("Pending", "Recent"),
        selectedTab = 1,
        selectedNav = 1,
        showFab = true,
    ) {
        ...
        TagRow(tags = listOf("Featured", "Archived", "Archived"))
...
@Preview
@Composable
internal fun BillingInvoice0ScreenPreview() {
    BillingInvoice0Screen()
}
