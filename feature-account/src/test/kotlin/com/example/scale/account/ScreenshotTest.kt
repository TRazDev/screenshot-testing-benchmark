...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        AccountTicket0Screen({ AccountTicket0ScreenPreview() }),
        AccountShipment1Screen({ AccountShipment1ScreenPreview() }),
        AccountRecipe2Screen({ AccountRecipe2ScreenPreview() }),
        AccountPortfolio3Screen({ AccountPortfolio3ScreenPreview() }),
        AccountArticle4Screen({ AccountArticle4ScreenPreview() })
    }
