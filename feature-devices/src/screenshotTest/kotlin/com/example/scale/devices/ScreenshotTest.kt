...
@ScreenshotMatrix
@Composable
fun DevicesInvoice0ScreenPreviewScreenshot() {
    DevicesInvoice0ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DevicesProject1ScreenPreviewScreenshot() {
    DevicesProject1ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DevicesBudget2ScreenPreviewScreenshot() {
    DevicesBudget2ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DevicesSubscription3ScreenPreviewScreenshot() {
    DevicesSubscription3ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DevicesHabit4ScreenPreviewScreenshot() {
    DevicesHabit4ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DevicesWorkout5ScreenPreviewScreenshot() {
    DevicesWorkout5ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DevicesProject6ScreenPreviewScreenshot() {
    DevicesProject6ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DevicesProject7ScreenPreviewScreenshot() {
    DevicesProject7ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DevicesAlbum8ScreenPreviewScreenshot() {
    DevicesAlbum8ScreenPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun DevicesProject9ScreenPreviewScreenshot() {
    DevicesProject9ScreenPreview()
}
