...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        DevicesInvoice0Screen({ DevicesInvoice0ScreenPreview() }),
        DevicesProject1Screen({ DevicesProject1ScreenPreview() }),
        DevicesBudget2Screen({ DevicesBudget2ScreenPreview() }),
        DevicesSubscription3Screen({ DevicesSubscription3ScreenPreview() }),
        DevicesHabit4Screen({ DevicesHabit4ScreenPreview() }),
        DevicesWorkout5Screen({ DevicesWorkout5ScreenPreview() }),
        DevicesProject6Screen({ DevicesProject6ScreenPreview() }),
        DevicesProject7Screen({ DevicesProject7ScreenPreview() }),
        DevicesAlbum8Screen({ DevicesAlbum8ScreenPreview() }),
        DevicesProject9Screen({ DevicesProject9ScreenPreview() })
    }
