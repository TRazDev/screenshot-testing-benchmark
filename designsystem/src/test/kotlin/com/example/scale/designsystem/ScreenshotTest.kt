...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        ButtonCatalog({ ButtonCatalogPreview() }, RenderingMode.SHRINK),
        CardCatalog({ CardCatalogPreview() }, RenderingMode.SHRINK),
        SelectionCatalog({ SelectionCatalogPreview() }, RenderingMode.SHRINK),
        ChipCatalog({ ChipCatalogPreview() }, RenderingMode.SHRINK),
        FieldCatalog({ FieldCatalogPreview() }, RenderingMode.SHRINK),
        ContentCatalog({ ContentCatalogPreview() }, RenderingMode.SHRINK)
    }
