...
@ScreenshotMatrix
@Composable
fun ButtonCatalogPreviewScreenshot() {
...
@ScreenshotMatrix
@Composable
fun CardCatalogPreviewScreenshot() {
    CardCatalogPreview()
}
...
@ScreenshotMatrix
@Composable
fun SelectionCatalogPreviewScreenshot() {
    SelectionCatalogPreview()
}

@PreviewTest
@ScreenshotMatrix
@Composable
fun ChipCatalogPreviewScreenshot() {
    ChipCatalogPreview()
}
...
@ScreenshotMatrix
@Composable
fun FieldCatalogPreviewScreenshot() {
    FieldCatalogPreview()
}
...
@ScreenshotMatrix
@Composable
fun ContentCatalogPreviewScreenshot() {
    ContentCatalogPreview()
}
