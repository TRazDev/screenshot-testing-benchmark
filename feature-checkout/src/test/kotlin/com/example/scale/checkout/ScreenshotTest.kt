...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        CheckoutWorkout0Screen({ CheckoutWorkout0ScreenPreview() }),
        CheckoutPortfolio1Screen({ CheckoutPortfolio1ScreenPreview() }),
        CheckoutSubscription2Screen({ CheckoutSubscription2ScreenPreview() }),
        CheckoutSubscription3Screen({ CheckoutSubscription3ScreenPreview() }),
        CheckoutPortfolio4Screen({ CheckoutPortfolio4ScreenPreview() }),
        CheckoutHabit5Screen({ CheckoutHabit5ScreenPreview() }),
        CheckoutArticle6Screen({ CheckoutArticle6ScreenPreview() }),
        CheckoutRoute7Screen({ CheckoutRoute7ScreenPreview() }),
        CheckoutDevice8Screen({ CheckoutDevice8ScreenPreview() }),
        CheckoutTask9Screen({ CheckoutTask9ScreenPreview() }),
        CheckoutProject10Screen({ CheckoutProject10ScreenPreview() }),
        CheckoutHabit11Screen({ CheckoutHabit11ScreenPreview() }),
        CheckoutRoute12Screen({ CheckoutRoute12ScreenPreview() }),
        CheckoutPlaylist13Screen({ CheckoutPlaylist13ScreenPreview() }),
        CheckoutReservation14Screen({ CheckoutReservation14ScreenPreview() })
    }
