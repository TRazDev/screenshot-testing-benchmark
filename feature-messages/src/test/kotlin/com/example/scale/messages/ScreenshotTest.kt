...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        MessagesPortfolio0Screen({ MessagesPortfolio0ScreenPreview() }),
        MessagesLesson1Screen({ MessagesLesson1ScreenPreview() }),
        MessagesArticle2Screen({ MessagesArticle2ScreenPreview() }),
        MessagesDevice3Screen({ MessagesDevice3ScreenPreview() }),
        MessagesDevice4Screen({ MessagesDevice4ScreenPreview() }),
        MessagesAlbum5Screen({ MessagesAlbum5ScreenPreview() }),
        MessagesSubscription6Screen({ MessagesSubscription6ScreenPreview() })
    }
