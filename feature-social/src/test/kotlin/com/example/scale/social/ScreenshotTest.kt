...
class ScreenshotTest(
    ...
    enum class Preview(
        ...
        SocialHabit0Screen({ SocialHabit0ScreenPreview() }),
        SocialTask1Screen({ SocialTask1ScreenPreview() }),
        SocialSubscription2Screen({ SocialSubscription2ScreenPreview() }),
        SocialWorkout3Screen({ SocialWorkout3ScreenPreview() }),
        SocialReservation4Screen({ SocialReservation4ScreenPreview() }),
        SocialTask5Screen({ SocialTask5ScreenPreview() }),
        SocialAlbum6Screen({ SocialAlbum6ScreenPreview() }),
        SocialPayment7Screen({ SocialPayment7ScreenPreview() }),
        SocialBudget8Screen({ SocialBudget8ScreenPreview() }),
        SocialTicket9Screen({ SocialTicket9ScreenPreview() }),
        SocialProject10Screen({ SocialProject10ScreenPreview() }),
        SocialExpense11Screen({ SocialExpense11ScreenPreview() }),
        SocialBudget12Screen({ SocialBudget12ScreenPreview() })
    }
